...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["loginEmail"]) && isset($_POST["loginSenha"])) {
        ...
        $sql = "SELECT id, senha FROM usuarios_adm WHERE email = ?";
        ...
        if ($result->num_rows > 0) {
            ...
            if (password_verify($loginSenha, $row["senha"])) {
                ...
                header("Location: http://localhost/KingPetShopXampp/cadastro_de_produtos.php"); // Redirecionar para a página de dashboard ou outra página após o login
                exit();
            } else {
